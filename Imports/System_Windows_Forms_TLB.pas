...
// ************************************************************************  //
// Type Lib: C:\Windows\Microsoft.NET\Framework\v4.0.30319\System.Windows.Forms.tlb (2)
...
const
  ...
  IID__ToolStripDropDownItemAccessibleObject: TGUID = '{8CA39678-9A2A-3D9A-8B0F-8D2DBA310960}';
  ...
  CLASS_ToolStripDropDownItemAccessibleObject: TGUID = '{F9CD025F-E53C-3516-830F-A3A0BF4A6AF3}';
...
// *********************************************************************//
  ...
  _ToolStripDropDownItemAccessibleObject = interface;
...
// *********************************************************************//
  ...
  ToolStripDropDownItemAccessibleObject = _ToolStripDropDownItemAccessibleObject;
...
// *********************************************************************//
  IDataObjectDisp = dispinterface
    ...
    function GetFormats(autoConvert: WordBool): {NOT_OLEAUTO(PSafeArray)}OleVariant; dispid 1610743818;
    function GetFormats_2: {NOT_OLEAUTO(PSafeArray)}OleVariant; dispid 1610743819;
  end;
...
// *********************************************************************//
  CoToolStripDropDownItemAccessibleObject = class
    ...
    class function CreateRemote(const MachineName: string): _ToolStripDropDownItemAccessibleObject;
  end;
...
class function CoToolStripDropDownItemAccessibleObject.Create: _ToolStripDropDownItemAccessibleObject;
begin
  Result := CreateComObject(CLASS_ToolStripDropDownItemAccessibleObject) as _ToolStripDropDownItemAccessibleObject;
end;

class function CoToolStripDropDownItemAccessibleObject.CreateRemote(const MachineName: string): _ToolStripDropDownItemAccessibleObject;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_ToolStripDropDownItemAccessibleObject) as _ToolStripDropDownItemAccessibleObject;
end;
